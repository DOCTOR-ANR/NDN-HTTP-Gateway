...
public:
    ...
    void resolve_handler(std::shared_ptr<NdnMessage> message);

    void on_data(const ndn::Interest &interest, const ndn::Data &data, std::shared_ptr<NdnMessage> message);

    void on_notify(const ndn::Interest &interest, const ndn::Data &data, std::shared_ptr<NdnMessage> message);

    void on_timeout(const ndn::Interest &interest, std::shared_ptr<NdnMessage> message, int left);

    void on_notify_timeout(const ndn::Interest &interest, std::shared_ptr<NdnMessage> message, int left);
};